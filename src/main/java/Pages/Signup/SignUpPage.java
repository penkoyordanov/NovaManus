...
//	WebDriverWait wait;
	...
	public SignUpPage setBirth(String birth){
		...
		Select monthDrodown = new Select(
                Browser.eDriver().findElement(By.xpath("//register-birth/div/select[starts-with(@class,'form-control')][1]")));
        monthDrodown.selectByVisibleText(dobSeparate[1]);
        Select dateDrodown = new Select(
                Browser.eDriver().findElement(By.xpath("//register-birth/div/select[starts-with(@class,'form-control')][2]")));
        dateDrodown.selectByVisibleText(dobSeparate[2]);
        Select yearDrodown = new Select(
                Browser.eDriver().findElement(By.xpath("//register-birth/div/select[starts-with(@class,'form-control')][3]")));
